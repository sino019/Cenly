      ...
      <div className="flex flex-col-reverse md:flex-row    ">
        <div className="md:w-1/4 flex justify-center  xl:p-2  w-full ">
          <img
            src={aboutImage}
            alt="About"
            className="object-cover rounded-lg shadow-lg w-auto h-auto md:w-80  md:h-80 mt-2"
          />
        </div>

        <div className="md:w-3/4  xl:p-2 text-justify">
          <h1 className="text-4xl font-bold mb-2 text-center xl:text-left">
            ABOUT ME
          </h1>
          ...
          <div className=" mb-4">
            <p className="mb-2">
              <strong>Name:</strong> Boy Cenly Dwi Sandes Pasella
            </p>
            <p className="mb-2">
              <strong>Age:</strong> 22
            </p>
            <p className="mb-2">
              <strong>Phone:</strong> +62 822 1177 9935
            </p>
            <p className="mb-2">
              <strong>Address:</strong> Kecamatan Kayu Aro, Kabupaten Kerinci,
              Jambi
            </p>
            <p className="mb-2">
              <strong>Current Position:</strong> Programmer at Lembaga
              Penelitian dan Pengabdian Masyarakat Universitas Andalas
            </p>
            <p className="mb-2">
              ...
              <a href="#" className="text-green-500 mx-1">
                WhatsApp
              </a>
            </p>
          </div>
